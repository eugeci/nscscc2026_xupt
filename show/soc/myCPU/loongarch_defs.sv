...
package loongarch_defs;
    ...
    localparam logic [16:0] LA_OP_DBAR    = 17'h070e4;
    localparam logic [16:0] LA_OP_IBAR    = 17'h070e5;
    localparam logic [16:0] LA_OP_IDLE    = 17'h00c91;
    ...
    localparam logic [9:0] LA_OP_PRELD   = 10'h0ab;

    // Atomic word operations use a signed 14-bit displacement scaled by four.
    localparam logic [7:0] LA_OP_LL_W = 8'h20;
    localparam logic [7:0] LA_OP_SC_W = 8'h21;
    ...
    function automatic logic [31:0] la_imm_si14_shift2(
        input logic [31:0] inst
    );
        la_imm_si14_shift2 = {{16{inst[23]}}, inst[23:10], 2'b00};
    endfunction
