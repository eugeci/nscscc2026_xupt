...
module nscscc_axi_bridge (
    ...
    input  logic        icache_maint_valid,
    input  logic [31:0] icache_maint_addr,
    input  logic [ 1:0] icache_maint_mode,
    output logic        icache_maint_done,

    input  logic        dmem_req_valid,
    output logic        dmem_req_ready,
    input  logic        dmem_req_write,
    input  logic        dmem_req_writeback,
    input  logic [31:0] dmem_req_addr,
    input  logic [ 2:0] dmem_req_size,
    ...
    memory_backend_arbiter u_memory_backend_arbiter (
        ...
        .d_req_writeback(dmem_req_writeback),
        .d_req_addr   (dmem_req_addr),
        .d_req_size   (dmem_req_size),
