...
module memory_access_unit #(
    ...
    input  logic        ex_cacheable_override_valid,
    input  logic        ex_cacheable_override,
    ...
    input  logic        ex_s1_cacheable_override_valid,
    input  logic        ex_s1_cacheable_override,
    ...
    assign is_cacheable = ex_cacheable_override_valid
                        ? ex_cacheable_override
                        : ((ex_alu_addr & CACHE_ADDR_MASK)
                           == (CACHE_ADDR_BASE & CACHE_ADDR_MASK));
    assign is_cacheable_s1 = ex_s1_cacheable_override_valid
                           ? ex_s1_cacheable_override
                           : ((ex_s1_alu_addr & CACHE_ADDR_MASK)
                              == (CACHE_ADDR_BASE & CACHE_ADDR_MASK));
