...
(
    ...
    input  logic [31:0]        s0_mem_vaddr,
    input  logic [31:0]        s0_mem_paddr,
    ...
    input  atomic_op_t         s0_atomic_op,
    ...
    input  logic [31:0]        s1_mem_vaddr,
    input  logic [31:0]        s1_mem_paddr,
    ...
    always_comb begin
        ...
        slot0_payload.mem_vaddr = s0_mem_vaddr;
        slot0_payload.mem_paddr = s0_mem_paddr;
        ...
        slot0_payload.atomic_op = s0_atomic_op;
        ...
        slot1_payload.mem_vaddr = s1_mem_vaddr;
        slot1_payload.mem_paddr = s1_mem_paddr;
