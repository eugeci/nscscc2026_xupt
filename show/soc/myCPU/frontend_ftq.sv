...
#(
    ...
    input  decode_exception_t irom_req_exception,
...
`endif
    ...
    frontend_fetch_state #(
        ...
        .accept_exception       (irom_req_exception),
    ...
    frontend_f0_packet_builder u_frontend_f0_packet_builder (
        ...
        .fetch_exception   (f0_state.fetch_exception),
    ...
    assign if_payload.slot0.fetch_exception = fq_head0.fetch_exception;
    assign if_payload.slot1.fetch_exception = fq_head1.fetch_exception;
